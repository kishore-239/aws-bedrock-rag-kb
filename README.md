...
- AWS account with Bedrock access (Claude 3.5 Sonnet + Titan Embeddings enabled in your region)
- Python 3.11+
...
| Claude 3.5 Sonnet | LLM | Strong instruction-following and citation accuracy for RAG tasks |
